...
NAVIGATION=array2table(zeros(ind,9),'VariableNames', ...
    ["CurrentState" "NextState" "nav_Cycs" "ACS" "LCS" "NC_counter" ...
     "ResetCluster" "BCF_counter" "EscapeFromCluster"]);

%Tabla RSSI
RSSI=table(zeros(ind,N_Son1),zeros(ind,N_Son2),zeros(ind,3),zeros(ind,1),zeros(ind,1),zeros(ind,5),'VariableNames',["RSSI_1" "RSSI_2" "Max" "Thld" "CH_Tx" "RSSI_CH"]);
