/************************************************************
 * LSM9DS1_Types.h  Created on: 28/01/2019                  *
 *                                                          *
...
#ifndef LSM9DS1DRIVER_LSM9DS1_TYPES_H_
#define LSM9DS1DRIVER_LSM9DS1_TYPES_H_
...
typedef enum interrupt_generators
{
...
typedef enum accel_interrupt_generator
{
    XLIE_XL = (1<<0),
    XHIE_XL = (1<<1),
    YLIE_XL = (1<<2),
...
typedef enum gyro_interrupt_generator
{
    XLIE_G = (1<<0),
    XHIE_G = (1<<1),
    YLIE_G = (1<<2),
...
typedef enum mag_interrupt_generator
{
    ZIEN = (1<<5),
    YIEN = (1<<6),
    XIEN = (1<<7)
...
#endif /* LSM9DS1DRIVER_LSM9DS1_TYPES_H_ */
